...
lxc-attach -n $CONT_NAME -- ln -s /qproddata/configs/package-mirror/nginx-proxy-server.conf /etc/nginx/sites-enabled/
lxc-attach -n $CONT_NAME -- ln -s /qproddata/configs/package-mirror/nginx-proxy-http.conf /etc/nginx/conf.d/
